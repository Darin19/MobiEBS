...
-- Scope & stewardship seed data. The deterministic IDs also match src/seed.ts.
insert into public.data_domains (id, organization_id, code, name, description, owner_user_id, status) values
  ('11000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000002', 'DVC', 'Dịch vụ công', 'Dữ liệu hồ sơ và thủ tục hành chính của Cổng DVC Quốc gia.', '00000000-0000-4000-8000-000000000004', 'Active'),
  ('11000000-0000-4000-8000-000000000002', '10000000-0000-4000-8000-000000000001', 'INV', 'Đầu tư', 'Dữ liệu đầu tư công và danh mục dự án.', '00000000-0000-4000-8000-000000000002', 'Active'),
  ('11000000-0000-4000-8000-000000000003', '10000000-0000-4000-8000-000000000004', 'TAX', 'Thuế', 'Dữ liệu thuế doanh nghiệp.', '00000000-0000-4000-8000-000000000006', 'Active'),
  ('11000000-0000-4000-8000-000000000004', '10000000-0000-4000-8000-000000000001', 'REF', 'Tham chiếu', 'Danh mục tham chiếu dùng chung.', '00000000-0000-4000-8000-000000000002', 'Active'),
  ('11000000-0000-4000-8000-000000000005', '10000000-0000-4000-8000-000000000005', 'CUSTOMS', 'Hải quan', 'Dữ liệu xuất nhập khẩu và hải quan.', '00000000-0000-4000-8000-000000000008', 'Paused'),
  ('11000000-0000-4000-8000-000000000006', '10000000-0000-4000-8000-000000000001', 'DVC-ODS', 'Dịch vụ công', 'Dữ liệu dịch vụ công đã được tích hợp vào ODS Bộ Tài chính.', '00000000-0000-4000-8000-000000000002', 'Active')
...
set
  owning_organization_id = case id
    when '50000000-0000-4000-8000-000000000001'::uuid then '10000000-0000-4000-8000-000000000002'::uuid
    when '50000000-0000-4000-8000-000000000002'::uuid then '10000000-0000-4000-8000-000000000001'::uuid
    when '50000000-0000-4000-8000-000000000003'::uuid then '10000000-0000-4000-8000-000000000004'::uuid
    when '50000000-0000-4000-8000-000000000004'::uuid then '10000000-0000-4000-8000-000000000001'::uuid
    when '50000000-0000-4000-8000-000000000005'::uuid then '10000000-0000-4000-8000-000000000005'::uuid
    when '50000000-0000-4000-8000-000000000006'::uuid then '10000000-0000-4000-8000-000000000001'::uuid
  end,
  custodian_organization_id = case id
    when '50000000-0000-4000-8000-000000000001'::uuid then '10000000-0000-4000-8000-000000000002'::uuid
    when '50000000-0000-4000-8000-000000000002'::uuid then '10000000-0000-4000-8000-000000000001'::uuid
    when '50000000-0000-4000-8000-000000000003'::uuid then '10000000-0000-4000-8000-000000000004'::uuid
    when '50000000-0000-4000-8000-000000000004'::uuid then '10000000-0000-4000-8000-000000000001'::uuid
  ...
  domain_id = case id
    when '50000000-0000-4000-8000-000000000001'::uuid then '11000000-0000-4000-8000-000000000001'::uuid
    when '50000000-0000-4000-8000-000000000002'::uuid then '11000000-0000-4000-8000-000000000002'::uuid
    when '50000000-0000-4000-8000-000000000003'::uuid then '11000000-0000-4000-8000-000000000003'::uuid
    when '50000000-0000-4000-8000-000000000004'::uuid then '11000000-0000-4000-8000-000000000004'::uuid
    when '50000000-0000-4000-8000-000000000005'::uuid then '11000000-0000-4000-8000-000000000005'::uuid
    when '50000000-0000-4000-8000-000000000006'::uuid then '11000000-0000-4000-8000-000000000006'::uuid
  end,
  governance_status = case id
...
insert into public.user_organization_roles (id, user_id, organization_id, role, status, valid_from) values
  ('12000000-0000-4000-8000-000000000001', '00000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000001', 'IntegrationAdmin', 'Active', '2026-01-01'),
  ('12000000-0000-4000-8000-000000000002', '00000000-0000-4000-8000-000000000002', '10000000-0000-4000-8000-000000000001', 'DataOwner', 'Active', '2026-01-01'),
  ('12000000-0000-4000-8000-000000000003', '00000000-0000-4000-8000-000000000003', '10000000-0000-4000-8000-000000000001', 'DataSteward', 'Active', '2026-01-01'),
  ('12000000-0000-4000-8000-000000000004', '00000000-0000-4000-8000-000000000004', '10000000-0000-4000-8000-000000000002', 'DataOwner', 'Active', '2026-01-01'),
  ('12000000-0000-4000-8000-000000000005', '00000000-0000-4000-8000-000000000005', '10000000-0000-4000-8000-000000000002', 'DataSteward', 'Active', '2026-01-01'),
  ('12000000-0000-4000-8000-000000000006', '00000000-0000-4000-8000-000000000006', '10000000-0000-4000-8000-000000000004', 'DataOwner', 'Active', '2026-01-01'),
  ('12000000-0000-4000-8000-000000000007', '00000000-0000-4000-8000-000000000007', '10000000-0000-4000-8000-000000000004', 'DataSteward', 'Active', '2026-01-01'),
  ('12000000-0000-4000-8000-000000000008', '00000000-0000-4000-8000-000000000008', '10000000-0000-4000-8000-000000000005', 'DataOwner', 'Active', '2026-01-01'),
  ('12000000-0000-4000-8000-000000000009', '00000000-0000-4000-8000-000000000009', '10000000-0000-4000-8000-000000000005', 'DataSteward', 'Active', '2026-01-01')
on conflict (id) do update set
...
insert into public.governance_scopes (id, organization_id, scope_type, domain_id, asset_id, status, valid_from, valid_to, created_by) values
  ('13000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000002', 'Domain', '11000000-0000-4000-8000-000000000001', null, 'Active', '2026-01-01', '2026-12-31', '00000000-0000-4000-8000-000000000001'),
  ('13000000-0000-4000-8000-000000000002', '10000000-0000-4000-8000-000000000001', 'Domain', '11000000-0000-4000-8000-000000000002', null, 'Active', '2026-01-01', '2027-01-01', '00000000-0000-4000-8000-000000000001'),
  ('13000000-0000-4000-8000-000000000003', '10000000-0000-4000-8000-000000000004', 'Domain', '11000000-0000-4000-8000-000000000003', null, 'Active', '2026-01-01', '2026-09-25', '00000000-0000-4000-8000-000000000001'),
  ('13000000-0000-4000-8000-000000000004', '10000000-0000-4000-8000-000000000001', 'Asset', null, '50000000-0000-4000-8000-000000000004', 'Active', '2026-01-01', '2027-01-01', '00000000-0000-4000-8000-000000000001'),
  ('13000000-0000-4000-8000-000000000005', '10000000-0000-4000-8000-000000000005', 'Domain', '11000000-0000-4000-8000-000000000005', null, 'Paused', '2026-01-01', '2026-12-31', '00000000-0000-4000-8000-000000000001')
on conflict (id) do update set
  status = excluded.status,
  valid_from = excluded.valid_from,
  valid_to = excluded.valid_to;

insert into public.stewardship_assignments (id, scope_id, assignment_role, user_id, assigned_by, assigned_at, accepted_at, valid_from, valid_to, status, is_primary, reason) values
  ('14000000-0000-4000-8000-000000000001', '13000000-0000-4000-8000-000000000001', 'DataOwner', '00000000-0000-4000-8000-000000000004', '00000000-0000-4000-8000-000000000001', '2026-09-09T09:00:00Z', '2026-09-09T09:00:00Z', '2026-01-01', '2026-12-31', 'Active', true, null),
  ('14000000-0000-4000-8000-000000000002', '13000000-0000-4000-8000-000000000001', 'DataSteward', '00000000-0000-4000-8000-000000000005', '00000000-0000-4000-8000-000000000001', '2026-09-09T09:00:00Z', '2026-09-09T09:00:00Z', '2026-01-01', '2026-12-31', 'Active', true, null),
  ('14000000-0000-4000-8000-000000000003', '13000000-0000-4000-8000-000000000002', 'DataOwner', '00000000-0000-4000-8000-000000000002', '00000000-0000-4000-8000-000000000001', '2026-09-09T09:00:00Z', '2026-09-09T09:00:00Z', '2026-01-01', '2027-01-01', 'Active', true, null),
  ('14000000-0000-4000-8000-000000000004', '13000000-0000-4000-8000-000000000002', 'DataSteward', '00000000-0000-4000-8000-000000000003', '00000000-0000-4000-8000-000000000001', '2026-09-09T09:00:00Z', '2026-09-09T09:00:00Z', '2026-01-01', '2027-01-01', 'Active', true, null),
  ('14000000-0000-4000-8000-000000000005', '13000000-0000-4000-8000-000000000003', 'DataOwner', '00000000-0000-4000-8000-000000000006', '00000000-0000-4000-8000-000000000001', '2026-09-09T09:00:00Z', '2026-09-09T09:00:00Z', '2026-01-01', '2026-09-25', 'Active', true, null),
  ('14000000-0000-4000-8000-000000000006', '13000000-0000-4000-8000-000000000003', 'DataSteward', '00000000-0000-4000-8000-000000000007', '00000000-0000-4000-8000-000000000001', '2026-09-09T09:00:00Z', '2026-09-09T09:00:00Z', '2026-01-01', '2026-09-25', 'Active', true, null),
  ('14000000-0000-4000-8000-000000000007', '13000000-0000-4000-8000-000000000004', 'DataOwner', '00000000-0000-4000-8000-000000000002', '00000000-0000-4000-8000-000000000001', '2026-09-09T09:00:00Z', '2026-09-09T09:00:00Z', '2026-01-01', '2027-01-01', 'Active', true, null),
  ('14000000-0000-4000-8000-000000000008', '13000000-0000-4000-8000-000000000004', 'DataSteward', '00000000-0000-4000-8000-000000000003', '00000000-0000-4000-8000-000000000001', '2026-09-09T09:00:00Z', null, '2026-09-15', '2027-01-01', 'Awaiting Acceptance', true, 'Chờ xác nhận tiếp nhận phạm vi danh mục địa bàn.'),
  ('14000000-0000-4000-8000-000000000009', '13000000-0000-4000-8000-000000000005', 'DataSteward', '00000000-0000-4000-8000-000000000009', '00000000-0000-4000-8000-000000000001', '2026-09-09T09:00:00Z', '2026-09-09T09:00:00Z', '2026-01-01', '2026-12-31', 'Active', true, null)
on conflict (id) do update set
  status = excluded.status,
...
insert into public.scope_change_requests (id, scope_id, request_type, requested_by, target_user_id, target_asset_id, target_domain_id, reason, status, reviewer_id, reviewer_comment, reviewed_at) values
  ('15000000-0000-4000-8000-000000000001', '13000000-0000-4000-8000-000000000003', 'EXPAND_DOMAIN', '00000000-0000-4000-8000-000000000007', null, '50000000-0000-4000-8000-000000000003', '11000000-0000-4000-8000-000000000003', 'Bổ sung trách nhiệm governance cho tài sản thuế mới phát hiện khi discover schema.', 'Pending Approval', null, null, null),
  ('15000000-0000-4000-8000-000000000002', '13000000-0000-4000-8000-000000000001', 'TRANSFER_STEWARD', '00000000-0000-4000-8000-000000000005', '00000000-0000-4000-8000-000000000003', null, null, 'Đề nghị chuyển giao stewardship trong kỳ luân chuyển nhân sự.', 'Changes Requested', '00000000-0000-4000-8000-000000000001', 'Bổ sung ngày hiệu lực và xác nhận từ người nhận trước khi duyệt.', '2026-09-09T09:00:00Z')
on conflict (id) do update set
  status = excluded.status,
...
insert into public.governance_notifications (id, user_id, organization_id, type, title, detail, entity_type, entity_id) values
  ('16000000-0000-4000-8000-000000000001', '00000000-0000-4000-8000-000000000007', '10000000-0000-4000-8000-000000000004', 'SCOPE_EXPIRING', 'Scope Thuế sắp hết hiệu lực', 'Phạm vi Domain Thuế sẽ hết hiệu lực ngày 25/09/2026.', 'GovernanceScope', '13000000-0000-4000-8000-000000000003'),
  ('16000000-0000-4000-8000-000000000002', '00000000-0000-4000-8000-000000000003', '10000000-0000-4000-8000-000000000001', 'SCOPE_ASSIGNED', 'Có stewardship mới chờ xác nhận', 'Danh mục địa bàn được giao từ ngày 15/09/2026.', 'StewardshipAssignment', '14000000-0000-4000-8000-000000000008')
on conflict (id) do update set
